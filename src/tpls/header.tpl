...
<html lang="ru">
   ...
   <body>
       ...
       <div class="jumbotron jumbotron-fluid">
           <div class="container">
               <h1 class="display-6">Webcli ({{radius}})</h1>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <dl class="row">
          ...
          <dd class="col-sm-12">Добавление временно действующих mac адресов для тестирования 
          при подключении абонентов. Порядок удаления записей упраляется модулем oracli. 
          </dd>
